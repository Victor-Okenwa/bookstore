    ...
    return (
        <div className='fixed bg-black bg-opacity-60 top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center'
            ...
            <div onClick={(e) => e.stopPropagation()}
                ...
                <h4 className='ny-2 text-gray-500'>{book._id}</h4>
                ...
                <p className="my-2">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis repellat libero id facere tempore pariatur veniam quia qui reiciendis adipisci!
                </p>
            </div>
        </div>
    )
